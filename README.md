...
O projekcie
----------
Program ma za zadanie stanowić bibliotekę obsługującą mikroprocesor podłączony za pomocą interfejsu RS232 dla aplikacji FinallyHome.

Licencja
----------

FinallyHome Server DLL - biblioteka dla aplikacji FinallyHome.
